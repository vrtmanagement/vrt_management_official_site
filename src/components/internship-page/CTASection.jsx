  ...
  return (
    <article className="group">
      <Link
        ...
        className="flex items-start gap-4 rounded-2xl transition duration-300 hover:translate-x-1 hover:brightness-110"
      >
        <div className="mt-1 flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-white shadow-[0_12px_30px_rgba(255,255,255,0.18)]">
          <Icon className="h-6 w-6 text-[#ff1f10]" strokeWidth={2.15} />
        </div>
        ...
        <div className="max-w-[295px]">
          ...
          <p className="mt-3 text-[16px] leading-[1.25] text-white/88">
            {item.description}
          </p>

          <span className="mt-3 inline-block text-[16px] font-medium leading-none text-white underline underline-offset-[3px] decoration-white/80">
            {item.linkLabel}
          </span>
        </div>
      </Link>
  ...
  return (
    <section className="w-full bg-white py-14 md:py-16">
      <div className="mx-auto w-full max-w-[1280px] px-6 md:px-10">
        <div className="relative overflow-hidden rounded-[24px] bg-[linear-gradient(90deg,#c30f19_0%,#ff3e15_50%,#c11018_100%)] px-8 py-10 shadow-[0_26px_70px_rgba(199,28,28,0.18)] md:px-14 md:py-12 lg:px-20 lg:py-14">
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[minmax(0,1.08fr)_minmax(320px,0.92fr)] lg:gap-14">
            <div className="max-w-[510px]">
              <h2 className="text-[42px] font-bold leading-[1.02] tracking-[-0.02em] text-white sm:text-[48px]">
                Ready to Start?
              </h2>

              <p className="mt-4 max-w-[430px] text-[23px] font-medium leading-[1.12] text-white/95 sm:text-[24px]">
                Have Questions? VRT Management Group Is Here to Help.
              </p>

              <p className="mt-5 max-w-[500px] text-[18px] leading-[1.18] text-white/90 sm:text-[19px]">
            ...
            <div className="flex flex-col gap-7 lg:pl-2">
