...
export default function EEHeroSection() {
  return (
    <section className="relative w-full h-100vh flex items-center overflow-hidden pt-10">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(252.28deg, rgba(200, 5, 6, 0.4) 76.4%, rgba(98, 2, 3, 0.4) 156.91%)",
        }}
      />
      ...
      <div className="relative z-[10] max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
        <div className="max-w-3xl">
          ...
          >
            Trusted by 1,500+ Entrepreneurs
          </p>
        </div>
      </div>
    </section>
