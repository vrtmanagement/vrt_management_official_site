          ...
          {FAQ_ITEMS.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="rounded-xl overflow-hidden transition-colors duration-200"
                style={{ backgroundColor: "#FBEBF0" }}
              >
                <div className="w-full grid grid-cols-[auto_1fr_auto] gap-4 sm:gap-5 items-start text-left py-5 px-5 sm:py-6 sm:px-6 border-0 bg-transparent">
