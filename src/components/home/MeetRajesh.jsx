...
export default function MeetRajesh() {
  return (
    <section className="relative py-10 lg:py-0 bg-[#1f1f1f] text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-0">
      <div className="grid gap-8 lg:gap-0 lg:grid-cols-[60%_40%] items-center">
      <div className="order-2 lg:order-1 md:max-w-2xl lg:max-w-none md:mx-auto md:text-center lg:text-left">
            ...
            <p className="text-md text-white/80 mb-4 md:mb-6 leading-7 max-w-4xl md:mx-auto">
            ...
            <p className="text-md text-white/80 mb-3 md:mb-5 max-w-3xl md:mx-auto ">
            ...
            <div className="mt-0 md:mt-8 md:flex md:justify-center lg:block">
            <LoadingButton
  ...
  <div className="rounded-2xl overflow-hidden items-start
                  w-[260px] 
                  sm:w-[300px]
                  md:w-[340px] 
                  lg:w-[420px]">
