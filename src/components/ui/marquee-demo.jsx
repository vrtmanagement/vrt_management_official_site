...
const CompanyLogos = {
  ...
  microsoft: () => (
    <div className="flex items-center justify-center h-16 w-48">
      <img 
        src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.microsoft.com%2Fen-us%2Flegal%2Fintellectualproperty%2Ftrademarks&psig=AOvVaw1389LZDTwfPtmyMBWj6jXW&ust=1759944598849000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCPjDoNfOkpADFQAAAAAdAAAAABAE" 
        alt="Microsoft" 
        className="h-12 w-auto object-contain filter grayscale hover:grayscale-0 transition-all duration-300"
      />
    </div>
