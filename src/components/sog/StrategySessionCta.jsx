...
const StrategySessionCta = () => {
  return (
    <section className="relative overflow-hidden bg-[#0B132B] py-16 md:py-20">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 shadow-[0_20px_60px_rgba(0,0,0,0.35)] backdrop-blur-sm md:p-10">
          <p className="mb-3 text-sm font-semibold uppercase tracking-[0.14em] text-[#FCA5A5]">
            ...
            <div className="mt-3 grid gap-3 md:grid-cols-2">
              {promisePoints.map((point) => (
                <p key={point} className="text-sm leading-relaxed text-slate-200">
                  <span className="mr-2 text-[#FCA5A5]">→</span>
                  {point}
                </p>
              ))}
            </div>
