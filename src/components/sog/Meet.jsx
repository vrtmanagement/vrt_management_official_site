      ...
      <>
        ...
        */}
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-12 px-10 md:items-center lg:flex-row lg:items-center lg:justify-between"> 
            ...
            <div className="order-1 relative h-[420px] w-full max-w-2xl flex justify-center lg:order-2 lg:justify-end">
            <div className="absolute left-1/2 top-[40px] h-[360px] w-[360px] -translate-x-1/2 rounded-full bg-[#FFD6D6] lg:left-auto lg:right-auto lg:translate-x-0" />
