        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
                ...
                <div className="text-center mb-6 md:mb-8">
                    ...
                    <p className="text-sm md:text-base text-gray-700 max-w-4xl mx-auto mb-3 leading-relaxed">
                        At the core of <span className='font-extrabold'> EGA<sup className="text-xs ">©</sup></span>  is <span className='font-bold'>" Growth as a Process "</span>. When the right systems are implemented, growth becomes predictable, scalable, and no longer dependent on luck or constant CEO intervention.
                        </p>
