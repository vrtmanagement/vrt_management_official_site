      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="text-center mb-6 md:mb-8">
         <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-[#ff4b5c] mb-2">
          Why VEGA<sup className="text-md ">©</sup> Exists (The Entrepreneur Problem)
        </h2>
          ...
          <div className="h-[380px] md:h-[420px] flex flex-col">
            ...
            <div className="mt-2 rounded-xl bg-[#ffe0df] border border-[#ffb4ae] px-3 py-2 text-xs">
             ...
             <p className="text-gray-800 text-xs mt-2">
              VEGA<sup className="text-[10px]">©</sup> was designed to install <span className="font-bold">Growth as a Process</span> system for founders and CEOs to deliver consistent results and sustained business.
            </p>
            </div>
          </div>
        </div>
