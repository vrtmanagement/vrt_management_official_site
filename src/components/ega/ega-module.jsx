...
const accordionData = [
    {
        ...
        content: {
            paragraphs: [
                ...
                "You won’t just learn theory, you’ll get actionable strategies you can apply immediately in your leadership, operations, team structure, and decision-making.",
            ],
            bullets: [
                "A clear understanding of why change is hard and how to make it constant.",
                "A personalized view of where you are on the Change Curve (from denial to ownership).",
                "A practical toolkit to help you shift from awareness to real behavior change.",
                "The ability to apply FAST goal setting across your teams for better alignment and accountability.",
                "A powerful mindset to lead in uncertainty, make decisions quicker, and outpace competitors."
            ],
            whyImportant: "Because what worked for your business even 6 months ago may not work tomorrow. And if you’re not actively changing, your business won’t just slow down, it’ll get left behind. This session helps you recognize that and gives you the tools to stay ahead, adapt faster, and lead stronger.",
        }
    },
    {
        weekNumber: 2,
        ...
        content: {
            ...
            bullets: [
                ...
                "A guide to using Trust as a leadership advantage in hiring, collaboration, and delivery."
            ],
            whyImportant: "This module isn't just helpful, it's a game-changer. Because when Trust increases, speed rises, costs decrease, and results multiply. And that's not theory; it's a fact every growing business needs to master on building Trust.",
        }
    },
    {
        weekNumber: 3,
    ...
    },
    {
        ...
        content: {
            ...
            bullets: [
                ...
                "An understanding of the 3 Growth Zones: Preparation, Performance, and Pressure and how each one affects your daily decisions.",
            ...
            whyImportant: "Because every stage of growth comes with its own challenges and if you treat them all the same, you'll keep solving the wrong problems. This session gives you the clarity to lead your business with precision, adapt to change faster, and unlock the next level of sustainable growth.",
        }
    },
    {
        weekNumber: 5,
        ...
        content: {
            ...
            whyImportant: "Because without a clear charter, your team ends up guessing. And when people guess, projects drag, priorities shift, and momentum dies. This session gives you a plug-and-play tool to bring structure, clarity, and speed to every project, so things actually get done.",
        }
    },
    {
        weekNumber: 6,
        ...
        content: {
            ...
            whyImportant: "Because businesses don't grow from vague goals; they grow from focused execution.Without a strategic plan, you're left to guess. This module gives you structure, focus, and execution discipline so your team knows what to do, when to do it, and why it matters.",
        }
    },
    {
        weekNumber: 7,
        ...
        content: {
            ...
            whyImportant: "Because growth doesn't happen in sprints, it occurs through discipline, structure, and consistency. This session helps you build that system, so your business doesn't grow once; it keeps growing all year. ",
        }
    },
    {
        weekNumber: 8,
        ...
        content: {
            ...
            whyImportant: "Because emotional intelligence isn't a nice-to-have anymore, it's a competitive advantage. Leaders with high emotional intelligence (EQ) create safer work environments, make better decisions, and build stronger teams. This session provides you with the skills to do exactly that, intentionally, not by accident.",
        }
    },
    {
        weekNumber: 9,
        ...
        content: {
            ...
            whyImportant: "Because culture isn't what's written on the wall, it's what happens when no one is watching. This session gives you the building blocks to shape a culture where your people feel aligned, committed, and proud to be part of the mission.",
        }
    },
    {
        weekNumber: 10,
        ...
        content: {
            ...
            whyImportant: "Because talent isn't just who you hire, it's how well you set them up to succeed. This session helps you eliminate guesswork in hiring, reduce turnover, and create a team that fits your business.",
        }
    },
