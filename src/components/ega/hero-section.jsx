    ...
    >
      ...
      <div className="container relative z-10 mx-auto flex flex-col items-center px-4 py-32 text-center text-white md:py-40 lg:py-52">
        ...
        <p className="mt-8 max-w-3xl font-body text-lg leading-relaxed text-white/95 md:text-xl">
          Founder University is a 10-week pre-accelerator helping tech startups build, launch, and delight customers.
        </p>
        <p className="mt-3 max-w-3xl font-body text-lg leading-relaxed text-white/95 md:text-xl">
          We invest $25k or $125k into the top graduates.
        </p>

        <a
          href="https://forms.launch.co/apply?prog=fun&Src=Skip+to+Content&mkt="
