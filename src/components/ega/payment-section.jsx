      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="border-2 border-red-500 rounded-2xl px-8 py-10 shadow-md">
          <div>
           ...
           Are You Ready to Register Your Spot in VEGA<sup className="text-md ">©</sup>?
          </h2>

          </div>
          <div>
            <p className="text-lg md:text-xl text-center text-gray-700 mb-6">
            Complete your secure payment for the Visionary Entrepreneur Growth Accelerator<sup className="text-xs ">©</sup> using the official VRT Management Group checkout link.
          </p>
